...
int mixture_save_to_file( Mixture* , char* );
Mixture* mixture_load_from_file( char* );
...
void mixture_evaluategrid_diagonal_multi( Mixture*, double*, uint32_t, double*, uint32_t, uint16_t, uint16_t*, double* );
